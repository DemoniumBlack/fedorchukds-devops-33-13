...
1. Создал null_resource по примеру из  ***demonstration2***, но для применения ansible-playbook к ВМ пришлось увеличить время ожидания запуска виртуальных машин "sleep" до 120 секунд.
